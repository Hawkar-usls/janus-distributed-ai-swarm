...
This repository contains the public firmware surface for a heterogeneous ESP32/M5Stack swarm: UI stations, telemetry/observer nodes, experimental workers and current ESP32-P4 bring-up code.
